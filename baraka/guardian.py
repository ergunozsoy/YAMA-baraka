...
def run(gh: GitHubClient, owner: str, name: str, repo_data: dict) -> list[Finding]:
    ...
    if repo_data.get("license"):
        ...
        findings.append(Finding("Bekçi", "Lisans", "warn", "Lisans dosyası yok."))

    # 3. SECURITY.md
    if gh.has_path(owner, name, "SECURITY.md"):
        findings.append(Finding("Bekçi", "SECURITY.md", "ok", "Güvenlik politikası mevcut."))
    else:
        findings.append(Finding("Bekçi", "SECURITY.md", "warn", "SECURITY.md yok."))

    # 4. Kök dizinde sızıntı izi
